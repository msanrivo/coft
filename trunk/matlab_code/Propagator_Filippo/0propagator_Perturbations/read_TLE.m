function [oe, iflag] = read_TLE(fname, mu)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function reads two-line element set
% mu standard gravitational parameter for the earth
% fname TLE file name 
%
% Based on Two Line Element script by Small Satellites
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
