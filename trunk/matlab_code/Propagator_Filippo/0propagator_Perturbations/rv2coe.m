...
function pout = rv2coe (p0);
    
r=0.001*[p0(1) p0(2) p0(3)];
v=0.001*[p0(4) p0(5) p0(6)];

mu=3.986004e5; %3.958042e5; 
small     = 0.00000001;
undefined = 999999.1;
twopi=2*pi;
...
pout=[a*1000, ecc, incl*180/pi, omega*180/pi, argp*180/pi, m*180/pi];
